							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="10">
											<input type="text" id="playNo" name="playNo" class="w20" title="제목을 입력해주세요" value='21'/>	
										</td>
									</tr>
									<tr>
										<th scope="row" colspan="2"><label for="">* 작가</label></th>
										<td colspan="10">
											<input type="text" id="artist" name="artist" class="w100" value='작가 : 이승효' />
										</td>
									</tr>
									<tr>
										...
										<td colspan="2">
											<input type="text" id="priceAdult" name="priceA" class="w5" value='9000'/>	
										</td>
									</tr>
			                        <tr>
				                        <th scope="col">청소년<br></th>
				                        <td colspan="2">
											<input type="text" id="priceTeenager" name="priceTeenager" class="w5" value='500' />	
										</td>
			                        </tr>									
			                        <tr>
				                        <th scope="col">어린이<br></th>
				                        <td colspan="2">
											<input type="text" id="priceChildren" name="priceChildren" class="w5" value='100' />	
										</td>
			                        </tr>									
									<tr>
