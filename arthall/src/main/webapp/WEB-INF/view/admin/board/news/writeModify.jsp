		...
		<div id="container">
			<div id="content">
				...
				<div class="con">
					...
					<div id="bbs">
						<div id="bread">
							<form method="post" name="frm" id="fm" action="modify.do?no=${vo.no}" onsubmit="return check()" enctype="multipart/form-data">
								...
								<tbody>
									...
									<tr>
										...
										<input type="button" id="delbtn" onclick="delfile();" value="파일삭제" />
											...
											<input type="hidden" id="filename" name="filename" class="w100" value="${vo.filename}" />
										</c:if>
										</td>
									</tr>
								</tbody>
