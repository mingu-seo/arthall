...
<head>
    ...
    <script src="<%=request.getContextPath() %>http://code.jquery.com/jquery-3.4.1.js"></script>
        ...
        function ajaxView(id) {
        	...
        	$.ajax({
        		...
        		success : function(data) {
					...
					$("#dog_price").text(data.price);
					$("#dog_image").attr("src", "<%=request.getContextPath() %>/dog/images/"+data.image);
					$("#editBtn").attr("onclick", "location.href='/dog/dog/updateForm.do?id="+id+"';");
					$("#delBtn").attr("onclick", "delDog("+id+");");
        		},
        		error : function(data) {
        			console.log(data);
        		}
    ...
    <section id="main-section">
        ...
        <div class="paper">
            <div class="paper-holder">
                <a><img width="190" src="<%=request.getContextPath() %>/img/gallery/dog1.jpg"></a>
            </div>
            <p class="paper-description">말티즈</p>
            <div class="paper-content">
                <p class="paper-text">가격 : 10,000원</p>
            </div>
        </div>
        <div class="paper">
            <div class="paper-holder">
                <a><img width="190" src="<%=request.getContextPath() %>/img/gallery/dog4.gif"></a>
            </div>
            <p class="paper-description">말티즈</p>
            <div class="paper-content">
                <p class="paper-text">가격 : 10,000원</p>
        ...
        <div class="paper">
            <div class="paper-holder">
                <a><img width="190" src="<%=request.getContextPath() %>/img/gallery/dog2.jpg"></a>
            </div>
            <p class="paper-description">말티즈</p>
            <div class="paper-content">
                <p class="paper-text">가격 : 10,000원</p>
        ...
        <div class="paper">
            <div class="paper-holder">
                <a><img width="190" src="<%=request.getContextPath() %>/img/gallery/dog3.jpg"></a>
            </div>
            <p class="paper-description">말티즈</p>
            <div class="paper-content">
                <p class="paper-text">가격 : 10,000원</p>
        ...
        <div id="lightbox">
            <div class="user-information">
                <div class="user-information-text">
                    ...
                    <p id="dog_price">10,000원</p>
                </div>
            </div>
            <hr class="lightbox-spllitter">
            <img id="dog_image" src="<%=request.getContextPath() %>http://placekitten.com/600/750">
        </div>
    </div>
</body>
</html>
